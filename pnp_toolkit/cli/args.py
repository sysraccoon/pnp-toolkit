...
def parse_arguments(args=None):
    ...
    build_pdf_parser = action_subparser.add_parser("build-pdf",
                                                   help="build pdfs from multiple images and specification")
    ...
    build_pdf_parser.add_argument("out_dir", type=str, default="build_pdf_out", nargs="?")
